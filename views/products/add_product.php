<h1 class="page-name">Agregar un producto</h1>
<p class="page-details">Llena los datos para agregar un producto</p>
...
<form action="/products/add" method="POST" class="form">
    <?php include_once __DIR__ . '/form.php' ?>
    <div class="container-submit">
        <input type="submit" class="boton" value="Agregar producto">
    </div>
</form>