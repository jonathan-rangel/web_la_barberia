...
<h2 class="page-details">Editar comentario</h2>
<p class="text-align">Puedes modificar sólo el contenido del comentario</p>
...
<form method="POST" class="form">
    ...
    <div class="field">
        ...
        <textarea rows="6" cols="50" id="comment_details" name="comment_details"><?php echo $comment->comment_details; ?></textarea>
    </div>
